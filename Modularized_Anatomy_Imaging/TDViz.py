...
class TDViz(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.transferFunctionControlItems = TransferFunctionControlItems.TransferFunctionControlItems(self)
        self.planeWidgetControlItems = PlaneWidgetControlItems.PlaneWidgetControlItems()
        self.playControlItems = PlayControlItems.PlayControlItems(self)
        self.smoothingControlItems = SmoothingControlItems.SmoothingControlItems(self)
