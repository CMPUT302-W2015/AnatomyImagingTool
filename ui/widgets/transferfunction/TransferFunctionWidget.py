...
class TransferFunctionWidget(QWidget):
	...
	def __init__(self):
		...
		self.histogramWidget.setAxeMode(bottom=HistogramWidget.AxeNormal, left=HistogramWidget.AxePercentage)
...
class NodeItemWidget(QWidget):
	...
	def __init__(self):
		...
		self.deleteButton = QPushButton("Delete Node")
	...
	def showColorDialog(self):
		color = QColorDialog.getColor(QColor(int(255*self.node.color[0]),int(255*self.node.color[1]),int(255*self.node.color[2]),255))
